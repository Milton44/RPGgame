...
public class IdleActionMonster : StateMachineBehaviour
{
     ...
     override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        if (monster.typeMode == Monster.TypeMonster.normal && monster.isIdleCoroutine) return;
        if (!monster.isIdleCoroutine || isPlayer )
        {
            if (monster.isIdleCoroutine) monster.StopIdleCoroutine();
